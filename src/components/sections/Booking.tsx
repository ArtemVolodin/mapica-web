          ...
          <AnimatePresence mode="wait">
            {submitted ? (
              ...
              >
                ...
                <h3 className="text-2xl font-semibold text-white">You&apos;re booked!</h3>
                <p className="mt-2 text-zinc-400">
                  {MONTHS[month]} {selectedDay} at {selectedSlot}. We&apos;ll send a confirmation to{" "}
                  {form.email}.
                </p>
              </motion.div>
            ) : (
                ...
                >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl glass border border-white/10 text-white placeholder:text-zinc-600 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/30 transition-all text-sm resize-none"
